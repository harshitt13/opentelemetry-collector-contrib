...
| `ottl.set.allowNil` | alpha | When enabled, the set function passes nil values directly to the target. | v0.157.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48714) |
