...
| `ottl.set.allowNil` | alpha | When enabled, the set function allows nil values to clear fields and unset maps and slices values. | v0.156.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48714) |
